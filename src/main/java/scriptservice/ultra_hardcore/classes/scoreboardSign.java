...
public class scoreboardSign {
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated
	 * to be used again
	 */
	public void destroy() {
		if (!created)
    ...
    public void setLine(scoreboardLines line, String value) {
        setLine(line.getLine(), value);
    }
    ...
    private VirtualTeam getOrCreateTeam(int line) {
        if (lines[line] == null)
            lines[line] = new VirtualTeam("__fakeScore" + line, line);
	...
	public class VirtualTeam {
        ...
        private VirtualTeam(String name, String prefix, String suffix, int lineIndex) {
            this.name = name;
            this.prefix = prefix;
            this.suffix = suffix;
        ...
        private VirtualTeam(String name, int lineIndex) {
            this(name, "", "", lineIndex);
        }
        ...
        public void setValue(String value) {
            String marker = "§" + Integer.toHexString(lineIndex);
            ...
            if (value.length() <= 14) {
                ...
                setPrefix(value.substring(0, 16));
                setPlayer(value.substring(16, 30) + marker);
                setSuffix(value.substring(30));
            } else {
                throw new IllegalArgumentException("Too long value ! Max 46 characters, value was " + value.length() + " !");
            }
        }
	}
